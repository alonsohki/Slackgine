...
.build-subprojects:
	...
	cd ../libsquish && ${MAKE} -j -f Makefile CONF=Release
...
.clean-subprojects:
	...
	cd ../libsquish && ${MAKE} -j -f Makefile CONF=Release clean
