...
LDLIBSOPTIONS=../l3m/dist/Profiling/GNU-Linux-x86/libl3m.a ../renderer/dist/Profiling/GNU-Linux-x86/librenderer.a `pkg-config --libs glew` ../shared/dist/Profiling/GNU-Linux-x86/libshared.a `pkg-config --libs libpng` ../core/dist/Profiling/GNU-Linux-x86/libcore.a -lrt  

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/model_optimizer

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/model_optimizer: ../l3m/dist/Profiling/GNU-Linux-x86/libl3m.a
...
${OBJECTDIR}/delete_unused.o: delete_unused.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DPROFILING -I. -I.. `pkg-config --cflags glew` `pkg-config --cflags libpng`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/delete_unused.o delete_unused.cpp
...
${OBJECTDIR}/delete_unused_textures.o: delete_unused_textures.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DPROFILING -I. -I.. `pkg-config --cflags glew` `pkg-config --cflags libpng`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/delete_unused_textures.o delete_unused_textures.cpp

${OBJECTDIR}/delete_duplicates.o: delete_duplicates.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DPROFILING -I. -I.. `pkg-config --cflags glew` `pkg-config --cflags libpng`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/delete_duplicates.o delete_duplicates.cpp

${OBJECTDIR}/clean_texture_ids.o: clean_texture_ids.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DPROFILING -I. -I.. `pkg-config --cflags glew` `pkg-config --cflags libpng`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/clean_texture_ids.o clean_texture_ids.cpp

${OBJECTDIR}/filter.o: filter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DDEBUG -DPROFILING -I. -I.. `pkg-config --cflags glew` `pkg-config --cflags libpng`    -MMD -MP -MF $@.d -o ${OBJECTDIR}/filter.o filter.cpp
