...
${OBJECTDIR}/maths.o: maths.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/maths.o maths.cpp

${OBJECTDIR}/colourfit.o: colourfit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/colourfit.o colourfit.cpp

${OBJECTDIR}/singlecolourfit.o: singlecolourfit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/singlecolourfit.o singlecolourfit.cpp

${OBJECTDIR}/clusterfit.o: clusterfit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/clusterfit.o clusterfit.cpp

${OBJECTDIR}/squish.o: squish.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/squish.o squish.cpp

${OBJECTDIR}/rangefit.o: rangefit.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/rangefit.o rangefit.cpp

${OBJECTDIR}/colourblock.o: colourblock.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/colourblock.o colourblock.cpp

${OBJECTDIR}/alpha.o: alpha.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/alpha.o alpha.cpp

${OBJECTDIR}/colourset.o: colourset.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -I. -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/colourset.o colourset.cpp
