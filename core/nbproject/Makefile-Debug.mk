...
${OBJECTDIR}/model_renderer_factory.o: model_renderer_factory.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -DUSE_THREADS -DDEBUG -DDEBUG_VERY_VERBOSE -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/model_renderer_factory.o model_renderer_factory.cpp
...
${OBJECTDIR}/entity_components/scene.o: entity_components/scene.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -DUSE_THREADS -DDEBUG -DDEBUG_VERY_VERBOSE -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/entity_components/scene.o entity_components/scene.cpp
...
${OBJECTDIR}/entity_components/model_renderer.o: entity_components/model_renderer.cpp 
	${MKDIR} -p ${OBJECTDIR}/entity_components
	${RM} $@.d
	$(COMPILE.cc) -g -DUSE_THREADS -DDEBUG -DDEBUG_VERY_VERBOSE -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/entity_components/model_renderer.o entity_components/model_renderer.cpp
