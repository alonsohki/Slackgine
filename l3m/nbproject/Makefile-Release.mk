...
${OBJECTDIR}/components/unknown.o: components/unknown.cpp 
	${MKDIR} -p ${OBJECTDIR}/components
	${RM} $@.d
	$(COMPILE.cc) -O2 -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/components/unknown.o components/unknown.cpp

${OBJECTDIR}/components/morph.o: components/morph.cpp 
	${MKDIR} -p ${OBJECTDIR}/components
	${RM} $@.d
	$(COMPILE.cc) -O2 -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/components/morph.o components/morph.cpp
...
${OBJECTDIR}/components/require.o: components/require.cpp 
	${MKDIR} -p ${OBJECTDIR}/components
	${RM} $@.d
	$(COMPILE.cc) -O2 -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/components/require.o components/require.cpp
...
${OBJECTDIR}/components/camera.o: components/camera.cpp 
	${MKDIR} -p ${OBJECTDIR}/components
	${RM} $@.d
	$(COMPILE.cc) -O2 -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/components/camera.o components/camera.cpp
...
${OBJECTDIR}/components/pose.o: components/pose.cpp 
	${MKDIR} -p ${OBJECTDIR}/components
	${RM} $@.d
	$(COMPILE.cc) -O2 -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/components/pose.o components/pose.cpp
