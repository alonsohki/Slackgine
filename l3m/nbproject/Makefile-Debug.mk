...
${OBJECTDIR}/Components/geometry.o: Components/geometry.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/geometry.o Components/geometry.cpp

${OBJECTDIR}/Components/scene.o: Components/scene.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/scene.o Components/scene.cpp
...
${OBJECTDIR}/model.o: model.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/model.o model.cpp

${OBJECTDIR}/Components/texture.o: Components/texture.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/texture.o Components/texture.cpp
...
${OBJECTDIR}/Components/material.o: Components/material.cpp 
	${MKDIR} -p ${OBJECTDIR}/Components
	${RM} $@.d
	$(COMPILE.cc) -g -I.. -MMD -MP -MF $@.d -o ${OBJECTDIR}/Components/material.o Components/material.cpp
