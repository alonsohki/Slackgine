...
void GLES20_Renderer::setCamera ( const Matrix& matProjection, const Matrix& matLookat )
{
...
bool GLES20_Renderer::render ( Geometry* geometry, const Transform& transform )
{
